...
'MsgBox("description="&strDescription & vbNewLine &"vasplit=" &vasplit(0) & vbNewLine & "workstation=" & strComputerName & vbNewLine &"configuration=" &strConfiguration & vbNewLine & "floor=" &strFloor)